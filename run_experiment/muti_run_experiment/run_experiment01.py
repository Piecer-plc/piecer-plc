...
if __name__ == "__main__":
    ...
    deal_run_file.batch_create_run_py_file(new_pipelines[:100],concerned_stages, "1-1")
    run_experiments.batch_run(concerned_stages,"win_amd64","1-1",new_pipelines[:100],62)